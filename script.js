var Typer={
	...
	init: function(){// inizialize Hacker Typer
		...
		$.get(Typer.file,function(data){// get the text file
			Typer.text=data;// save the text file in Typer.text
 ...
 */
    ...
    function init() {
       ...
       log("Website", "A! ______  ___   __ __ _____ ");
       log("Website", "A!| _____ |  _\\  __ __ _____ ");
       log("Website", "A!| |     | |_||  _|     |");
       log("Website", "A!| |___  | | || ____| |_| |__|__|");
